...
import { Map, MapPin, User, UserPlus } from "react-feather";
import { Link } from "react-router-dom";
import "./Features.css";
function Features() {
  return (
    <div class="container px-4 pb-4" id="featured-3">
      <h3 class="pb-2 border-bottom text-center">Det er så nemt.</h3>
